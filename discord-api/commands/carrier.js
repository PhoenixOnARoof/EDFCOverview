...
function createFleetCarrierEmbed(fc) {
    ...
    return {
        ...
        fields: [
            ...
            {
                name: 'Cargo',
                value: `${fc.cargo.map(x => x.qty).reduce((x, y) => x + y, 0)} / ${fc.capacity.cargoForSale + fc.capacity.cargoNotForSale + fc.capacity.cargoSpaceReserved + fc.capacity.crew + fc.capacity.freeSpace}`,
                inline: true,
            },
            {
                name: 'Crew',
