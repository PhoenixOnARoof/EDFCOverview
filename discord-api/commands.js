...
const SUIT_COMMAND = {
  name: 'suit',
  description: 'View your current suit and loadout',
  type: 1,
  integration_types: [0, 1],
  contexts: [0, 1, 2],
};
...
const ALL_COMMANDS = [LOGIN_COMMAND, LOGOUT_COMMAND, FLEETCARRIER_COMMAND, PROFILE_COMMAND, MARKET_COMMAND, SHIPYARD_COMMAND, COMMUNITYGOALS_COMMAND, JOURNAL_COMMAND, SHIPS_COMMAND, SQUADRON_COMMAND, LASTSTARPORT_COMMAND, LASTSYSTEM_COMMAND, SUIT_COMMAND];
